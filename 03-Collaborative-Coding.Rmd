...
-   Always check your forked repository against the upstream repository before
    ...
    codebase using the terminal command `git fetch upstream`
...
-   Always commit your changes to your local repository or branch and push to
    GitHub at the end of your coding session as backup policy (as in: don't
    leave changes untracked when leaving work), ideally this also will result in
    a pull request to your internal creative partner. It's always easier to
    write a pull request when your work is fresh in your mind.
