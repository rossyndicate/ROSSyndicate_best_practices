...
4.  Once the repo is stored on your local machine create the general
    ...
    -   Populate the README.md with some basic information, including the
        ...
        include the following use license blurb: *'This repository is covered by
        the MIT use license. We request that all downstream uses of this work be
...
7.  Internal creative partner (or engaged individuals) reviews the pull request
    ...
    outlined in GitHub's How to Review Pull Requests. If no changes are
    required, the reviewer will merge the branch, but if any comments have been
    made on the pull request, leave the merging to the PR author.
