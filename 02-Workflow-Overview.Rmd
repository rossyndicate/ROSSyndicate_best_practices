...
As stated above, we tend to use SymLinks to shared OneDrive folders. To set up a
`data` SymLink folder, from a OneDrive path that ends with `/data/`, you can use
the following command in the terminal with the .Rproj open:
...
To quickly get started with SSH follow the directions in the sections "[Checking
for existing SSH
