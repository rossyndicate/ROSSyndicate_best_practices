...
except you have to parallel workflows with varying commit history in the same
...
independent of others' work on the repo -- or even your other branches! Try not
to leave your branches unmerged for long periods of time if other folks are
working in the same repository to help alleviate merge conflicts.
