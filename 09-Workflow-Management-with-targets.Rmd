...
-   [The {targets} R package user manual](https://books.ropensci.org/targets/) + [Improving ecological data science with workflow management software](https://doi.org/10.1111/2041-210X.14113) + [Targets for Ecologists](https://targets-ecology.netlify.app/)
